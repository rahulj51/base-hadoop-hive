...
Vagrant::Config.run do |config|
  ...
  # config.vm.forward_port 7777, 50070
 ...
 config.vm.provision :puppet, :options => "--verbose --debug" do |puppet|
  ...
  config.vm.define :backup do |backup_config|
    backup_config.vm.network :hostonly, "192.168.33.11"
  end
  
  config.vm.define :hadoop1 do |hadoop1_config|
    hadoop1_config.vm.network :hostonly, "192.168.33.12"
  end
  
  config.vm.define :hadoop2 do |hadoop2_config|
    hadoop2_config.vm.network :hostonly, "192.168.33.13"
  end
  
  config.vm.define :hadoop3 do |hadoop3_config|
    hadoop3_config.vm.network :hostonly, "192.168.33.14"
  end
